...
public class SuperMarket
{
     ...
     * @param message A string stating line number and action to take place.
     */
    ...
    public static void main(String[] args)
    {
        ...
        final String TESTFILE = "C:\\Users\\Fred.Kipkemoi\\Documents\\in.txt"; // Directory path for plain-text file
